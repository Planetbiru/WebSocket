		...
		while (true) 
		{
			...
			if (in_array($this->masterSocket, $this->changed)) 
			{
				...
				if(strlen($header) > 2 && stripos($header, 'Sec-WebSocket-Key') !== false)
				{
					...
					$chatClient = (new WSConnection($resourceId, $clientSocket, $header, $this->sessionCookieName, $this->sessionSavePath, $this->sessionFilePrefix, $this))
						->setRemoteAddress($remoteAddress)
						->setRemotePort($remotePort)
						->setLoginCallback('onClientLogin')
						;
